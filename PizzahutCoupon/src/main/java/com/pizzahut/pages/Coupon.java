...
//	WebElement ChoosePizza1;
	...
	public void m11()
	{
		...
		//try {
    		String expectedText = "Voucher applied! Rs. 125 Off on bill value above Rs.500.";
...
//    		applycouponcode.sendKeys("HUT125");
    		...
    		applycouponcode.sendKeys(prop.getProperty("Coupon"));
    		...
    		WebElement voucherappliedtxt1= voucherappliedtxt ;
    		
    		String vouchertxt=voucherappliedtxt1.getText();
    
	        org.testng.Assert.assertEquals(vouchertxt,expectedText );
	        
	        System.out.println(vouchertxt);
