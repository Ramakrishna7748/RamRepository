...
import org.openqa.selenium.By;
	...
	public class Test1 {
	    ...
	    //if the Cart value is below 500 we can add more quantity to make offer available
	    //we can also choose as many pizzas items to match the min cart value to avail the offer
	    @Test()
	    ...
	    public void m4() throws InterruptedException
	    {
	        ...
	        if (driver.findElement(By.xpath("//*[@id=\"basket\"]/div[1]/div/div/div[1]")).getText().equals(actual)) {
	            System.out.println("User is successfully able to apply the voucher for purchasing the pizza >= to Rs.500");
	        } else {
	            System.out.println("User is not able to apply the coupon since cartvalue less than 500 add more items to Avail this offer");
